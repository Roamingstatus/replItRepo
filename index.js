const namesAndNumbers = [
  "Bob","Sam",16,4,"Jo","Lyric",52,"Jemimah",67,"bo",79,"Tom","Joe"
...
const legacyInventors = inventors.filter(inventor =>  inventor.year >= 1500 && inventor.year <= 1599);
console.table(legacyInventors);
